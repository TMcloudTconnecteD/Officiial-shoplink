...
const ShopPortfolio = ({ shop, products }) => {
  ...
  // when closing, go to shops listing page
  const handleClose = () => {
    navigate("/shops/all"); // <-- adjust if your frontend route is different
  };
  ...
  return (
    <div className="flex flex-col md:flex-row bg-white rounded-lg shadow-lg p-4 sm:p-6 gap-6 max-w-7xl mx-auto">
      ...
      <div className="md:w-2/3 flex flex-col">
        {/* Carousel wrapper with height control */}
        <div className="relative w-full overflow-hidden rounded-lg shadow-md max-h-[250px] sm:max-h-[350px]">
